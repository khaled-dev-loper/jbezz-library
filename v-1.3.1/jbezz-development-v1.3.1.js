...
let resulater =  {
		...
		addClass:function(classname){
			return resulater.class.add(classname)
		},
		removeClass:function(classname){
			return resulater.class.remove(classname)
		},
		toggleClass:function(classname){
			return resulater.class.toggle(classname)
		},
		class:{
			get:function(){
				let arr = [];
		...
		on:function(eventStr,func){
			return resulater.run(function(e){e.addEventListener(eventStr,function(even){func(even,e)})});
		},
